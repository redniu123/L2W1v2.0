...
用法:
  python scripts/experiments/gemini_ceiling.py --mode correction
  python scripts/experiments/gemini_ceiling.py --mode ocr
  python scripts/experiments/gemini_ceiling.py --mode both   # 两个都跑
"""
