...
from scripts.experiments.efficiency_frontier import build_agent_b_callable,ensure_agent_a_result_schema,infer_all_samples
from scripts.experiments.online_budget_control import run_online_pipeline
...
if __name__=='__main__':
    ...
    root=REPO_ROOT;cfg=yaml.safe_load(Path(a.config).read_text(encoding='utf-8'));pv=a.prompt_version or cfg.get('prompt_version') or cfg.get('mainline',{}).get('prompt_version','prompt_v1.1');cfg2=json.loads(json.dumps(cfg));
