...
用法:
  # 云服务器挂机运行
  nohup python scripts/experiments/all_frontiers.py > logs/run_all_frontiers.log 2>&1 &

  # 快速测试 (前 50 个样本)
  python scripts/experiments/all_frontiers.py --n_samples 50
"""
...
def main():
    ...
    print("Next: python scripts/tools/visualize_master_frontier.py")
